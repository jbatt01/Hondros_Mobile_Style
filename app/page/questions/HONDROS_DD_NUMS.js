Ext.define('Player.page.questions.HONDROS_DD_NUMS', {
    extend: 'Player.page.questions.Question',

    alias: ['widget.HONDROS_DD_NUMS'],

    requires: ['Player.layout.Accordion', 'Player.page.questions.hondrosComponents.ddnums'],
    ...
    updateQuestionRecord: function(newRecord, oldRecord) {
        ...
        for(var i = 0, ln = distractorsList.length; i < ln; i++) {
            ...
            var tempItem = Ext.create('Player.page.questions.hondrosComponents.ddnums', {
                title: tempDef['#text'],
                pageData: tempDef,
                total: ln,
                cls: 'def-item',
